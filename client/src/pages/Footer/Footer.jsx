    ...
    <div className='footer'>
      <div className="container">
        <div className="top">
          ...
          <div className="item">
            <h1>More From WorkNest</h1>
            <span>WorkNest Community</span>
            <span>WorkNest Pro</span>
            <span>WorkNest Studios</span>
            <span>Get Inspired</span>

            {/* <span>WorkNest Guild</span>
        ...
        <div className="bottom">
          <div className="left">
            <h2>WorkNest</h2>
            <span>© WorkNest Private Ltd. {new Date().getFullYear()}</span>
          </div>
          <div className="right">
